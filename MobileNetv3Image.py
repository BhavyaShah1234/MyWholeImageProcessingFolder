...
for class_id, conf, bbox in zip(class_ids.flatten(), confidence.flatten(), bounding_box):
	cv.rectangle(img, bbox, color=(0, 255, 0), thickness=2)
	cv.putText(img, class_names[class_id-1].upper(), (bbox[0]+10, bbox[1]-10), cv.FONT_HERSHEY_DUPLEX, 1, (0, 255, 0), 1)
